...
pub mod p2p_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn example(
            ...
            let path = http::uri::PathAndQuery::from_static("/p2p.P2P/Example");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("p2p.P2P", "Example"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/p2p.P2P/Example" => {
                    ...
                    struct ExampleSvc<T: P2p>(pub Arc<T>);
                    impl<T: P2p> tonic::server::UnaryService<super::ExampleRequest>
                    for ExampleSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as P2p>::example(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
